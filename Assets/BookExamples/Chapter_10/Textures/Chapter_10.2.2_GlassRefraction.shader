Shader "Book Examples/Chapter_10.2.2/Glass Refraction"
{
    Properties
    {
    ...
    SubShader
    {
        // Queue must be transparent, so other objects are drawn before this one.
        Tags { "Queue" = "Transparent" "RenderType"="Opaque" }
        
        // This pass grabs the screen behind the object into a texture.
        // Access the result in the next pass as _RefractionTex.
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                // 透视除法:在进行屏幕空间采样时，所有的坐标都必须除以 w 分量，才能把齐次坐标转换回真正的 2D 屏幕坐标 [0, 1] 范围。
